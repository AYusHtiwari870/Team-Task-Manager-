...
import { Plus, CheckSquare, X, AlignLeft } from 'lucide-react';
...
export default function Tasks() {
  ...
  const fetchData = async () => {
    try {
      ...
      alert(err.response?.data?.detail || 'Error loading tasks. Please try again.');
    } finally {
      // future: clear any loading spinners here
    }
  };
  ...
  // Group by status for visual columns feel
